...
## 常见问题 (FAQ)
Q: 数据如何与真实线路保持一致？  
A: 地铁线路数据均内嵌在 HTML 文件中，修改和更新数据需编辑 beijing-subway-map-super.html 里的线路和站点数组，暂不支持自动在线同步外部数据源。

Q: 是否支持移动端？  
A: 支持部分移动端浏览，但最佳体验建议使用桌面浏览器。经代码实际测试，某些交互在手机浏览器上体验有限。

Q: 地铁线路怎么高亮？
A: 在图例或站点弹窗点选线路，可以高亮显示/取消高亮对应线路。
